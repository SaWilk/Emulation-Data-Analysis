...
% transform data from eeglab to fieldtrip format
% separate epochs for conditions and save to separate data structures
...
% add datapath and outputpath

%list all *.set files in datapath
