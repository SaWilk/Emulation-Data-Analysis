...
% new:
% separately for two time intervals:
% 0-500 ms
% 500 ms onwards
% --> for significant time intervals respectively
...
contrasts_A = {
    {'const', 'rand1'}, ...
    %{'const', 'rand2'}, ... % excluded based on theoretical considerations
    %{'rand1', 'rand2'} ... % excluded based on theoretical considerations
    };
...
load('R:\AG-Beste-Studien\Emulation\06_analysis\Emulation-Data-Output\10_CBPT\CBPT_avg_exclude_start.mat');
