...
% calculate ERSP for different trajs
...
% set input path
inputpath = "R:\AG-Beste-Studien\Emulation\06_analysis\Emulation-Data-Output\06_artifact_rejection_b";
cd(inputpath);

% set export directory
savepath = "R:\AG-Beste-Studien\Emulation\06_analysis\Emulation-Data-Output";
...
for sbj_ind = 1:length(files2read_A)
    ...
    for chan_ind = 1:TMPEEG_A.nbchan
        [erspconstant(:,:,chan_ind), ~, ~, ersptimes, erspfreqs] = newtimef(TMPEEG_A.data(chan_ind,:, traj == 1), ...
                ...
                TMPEEG_A.chanlocs, 'chaninfo', TMPEEG_A.chaninfo,'basenorm','off', ...
                'freqs', [2 30],  'nfreqs', 30,'plotphase','off', 'plotersp','off','plotitc','off',...
...
for sbj_ind = 1:length(files2read_B)
    ...
    for chan_ind = 1:TMPEEG_B.nbchan
        [erspocclon(:,:,chan_ind), ~, ~, ersptimes, erspfreqs] = newtimef(TMPEEG_B.data(chan_ind,:, occl == 1), ...
                ...
                TMPEEG_B.chanlocs, 'chaninfo', TMPEEG_B.chaninfo,'basenorm','off', ...
                'freqs', [2 30],  'nfreqs', 30,'plotphase','off', 'plotersp','off','plotitc','off',...
                'padratio', 1,'trialbase','full'); close;
