...
savepath = "R:\AG-Beste-Studien\Emulation\06_analysis\output_analysis_task_A_new\01_preprocessed";  

%list all *.vhdr files in data directory
filenames = dir('*_A.vhdr');
...
exclude = {'91L3H_A.vhdr', '607SE_A.vhdr', 'WM87B_A.vhdr'};
...
for ind = 1:length(files2read) 
    ...
    TMPEEG = pop_saveset(TMPEEG,'filename',[files2read{ind}(1:end-7) '_A_preprocessed'], 'filepath', char(savepath));
